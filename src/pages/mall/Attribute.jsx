...
import mallAttributeApi from '@/api/mall/attribute';

const defaultForm = { id: null, name: '', productGroupId: '' };

export default function Attribute() {
  const crud = useCrud({
    title: '属性',
    url: '/v1/attribute/searchByPage',
    crudMethod: mallAttributeApi,
    defaultForm,
  });
  ...
  return (
    <Box sx={{ p: 1 }}>
      ...
      <CrudDialog open={crud.dialogOpen} title={crud.dialogTitle}
        ...
        <TextField fullWidth label="属性名称" value={crud.form.name || ''}
